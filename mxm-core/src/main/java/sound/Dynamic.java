...
public class Dynamic implements Comparator<Dynamic>, Comparable<Dynamic> {
    ...
    /**
     * Compares this sound.Dynamic to another sound.Dynamic.
     * @param other The other sound.Dynamic.
     ...
     * @param p1 The first sound.Dynamic.
     * @param p2 The second sound.Dynamic.
     * @return The comparison.
     */
    @Override
    ...
    /**
     * Checks if this sound.Dynamic equals another Object.
     * @param o The other Object.
     * @return If this sound.Dynamic is equal to the Object.
     */
    @Override
     ...
     * @return The hash code for this sound.Dynamic.
     */
    @Override
    public int hashCode() {
        return (int) value;

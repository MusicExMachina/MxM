...
import properties.sound.IntervalClass;
import properties.sound.PitchClass;
import io.Log;
import org.jetbrains.annotations.NotNull;
import theory.patterns.Scale;

import java.util.*;

/**
 * <p> <b>Class Overview:</b>
 * Harmony is one of the most components of many MxM note classes, as it represents a specific subset of all possible

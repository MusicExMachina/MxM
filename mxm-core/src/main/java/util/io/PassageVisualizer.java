...
/*
    ...
    class PassageDrawer extends JPanel{
        public void paint(Graphics g) {
            ...
            for(Part part : form) {
                ...
                for(Sound properties: part) {
                    g.setColor(color);
                    g.fillRect( Math.round(properties.getStart().toFloat()*hScale),
                                Math.round(vScale - properties.getPitch().normalized()*vScale),
                                Math.round(properties.getLength().toFloat()*hScale+2),
                                5);
                }
            }
        }
    ...
    public static void main(String[] args) {
        try {
            ...
            //Sequence sequence = MidiTools.load("C:\\Users\\celenp\\Desktop\\GitHub\\util.io.Log\\mxm-midi\\src\\tests\\resources\\midi_schubertImpromptu.mid");
            ...
            MxmScoreWriter.write(form,"C:\\Users\\celenp\\Desktop\\GitHub\\util.io.Log\\mxm-gui\\src\\tests\\resources\\output");

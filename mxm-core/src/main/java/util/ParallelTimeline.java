...
final class ParallelTimeline <MusicEventType extends IMusicEvent> implements ITimeline<IFrame<MusicEventType>> {
    ...
    private final TreeMap<Time, IFrame<MusicEventType>> frames;
    ...
    @Override
    public final @NotNull IFrame<MusicEventType> getAt(@NotNull Time time) {
        return frames.get(time);
    }
    @Override
    public final @NotNull IFrame<MusicEventType> getBefore(@NotNull Time time) {
        return frames.floorEntry(time).getValue();
    }
    @Override
    public final @NotNull IFrame<MusicEventType> getAfter(@NotNull Time time) {

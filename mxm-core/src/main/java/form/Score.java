 ...
 * and the internal structures of the music. events.eventTypes.Note that a passage
 * is unified by its temporal nature- time signatures, tempos, and
 * the like.
 */
public class Score extends Passage implements Iterable<Part> {
    ...
    /**
     * Getter for the name of this Score.
    ...
    /**
     * Getter for the composer of this Score.
     * @return the composer of this Score.
     */
     ...
     * @param timeSignature The base.TimeSignature to add to this form.Score.

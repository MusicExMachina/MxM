...
public final class Pitch extends AbstractIntegerProp implements ISound, Comparator<Pitch>, Comparable<Pitch> {
    ...
    /**
     * Gets an instance of a sound with this "value", utilized in static initialization.
     * <b> Note that direct "value" static getters should be private and hidden from public view</b>
     *

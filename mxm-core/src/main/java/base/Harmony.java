...
public class Harmony {
    ...
    static {
        ...
        MxmLog.logInitialization("Harmony", Arrays.asList(ALL),System.nanoTime() - startTime);
    }
    ...
    public static final Harmony FULL = get(TOTAL_NUM);
    ...
    private static @NotNull Harmony get(int id) {
        ...
        else throw new Error("HARMONY:\tThis id does not exist!");
    }
    /**
     * Gets an instance of a given harmony. This method enforces the flyweight design pattern per noise.
    ...
    private Harmony(int id) {
        ...
        for(int pcVal = Pitch.MIN_VALUE; pcVal < Pitch.MAX_VALUE; pcVal++) {
